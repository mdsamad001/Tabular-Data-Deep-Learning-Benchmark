...
from .utils import _get_default_mmc, _default_rf_classifier, _get_regressor
...
class KernelDataSet(ImputedDataSet):
    ...
    def mice(self, estimator_name: str = 'RandomForest', iterations: int = 5, verbose: bool = False, **kw_fit):
        """
        ...
        for iteration in iter_range:
            ...
            for var in self.response_vars:
                ...
                if var in self.categorical_variables:
                    ...
                    current_model = _get_regressor(
                        random_state=self._random_state, estimator_name=estimator_name
                    )
