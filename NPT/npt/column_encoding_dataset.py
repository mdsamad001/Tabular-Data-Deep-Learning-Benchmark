...
from NPT.npt.batch_dataset import NPTBatchDataset
from NPT.npt.datasets.base import BaseDataset
from NPT.npt.datasets.my_dataset import CustomClassificationDataset
# from NPT.npt.datasets.boston_housing import BostonHousingDataset
# from NPT.npt.datasets.breast_cancer import (
#     BreastCancerClassificationDataset, BreastCancerDebugClassificationDataset)
# from NPT.npt.datasets.cifar10 import CIFAR10Dataset
# from NPT.npt.datasets.concrete import ConcreteDataset
# from NPT.npt.datasets.debug import DebugDataset
# from NPT.npt.datasets.forest_cover import ForestCoverClassificationDataset
# from NPT.npt.datasets.higgs import HiggsClassificationDataset
# from NPT.npt.datasets.image_utils import load_image_dataloaders
# from NPT.npt.datasets.income import IncomeDataset
# from NPT.npt.datasets.kick import KickDataset
# from NPT.npt.datasets.mnist import MNISTDataset
# from NPT.npt.datasets.poker_hand import PokerHandDataset
# from NPT.npt.datasets.protein import ProteinDataset
# from NPT.npt.datasets.yacht import YachtDataset
from NPT.npt.utils.cv_utils import (
    get_class_reg_train_val_test_splits, get_n_cv_splits)
from NPT.npt.utils.encode_utils import encode_data_dict
from NPT.npt.utils.memory_utils import get_size
from NPT.npt.utils.preprocess_utils import (
    get_matrix_from_rows)


extra_maps = {f'custom__{dataset_name}': CustomClassificationDataset for dataset_name in openml_cc18_list}
...
class ColumnEncodingDataset:
    ...
    def cache_metadata(self, data_dict):
        ...
        with open(self.metadata_path, 'w') as f:
            json.dump(metadata_dict, fp=f, cls=NpEncoder)
    ...
    def get_data_dict(self):
        ...
        print(data_dict['num_features'], data_dict['cat_features'])
    ...
    def generate_classification_regression_dataset(self, data_dict):
        ...
        for split_idx, (train_val_test_indices) in enumerate(
            ...
            # save_var(train_val_test_indices, f'./saved_vars/npt/{c.data_set}_fold-{split_idx}.pkl')
