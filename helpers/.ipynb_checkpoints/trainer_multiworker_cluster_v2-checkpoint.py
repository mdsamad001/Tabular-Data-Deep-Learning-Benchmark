...
def ae_training(dataset_name, batch_size,
    ...
    for fold_counter in range(fold_limit):
        ...
        train_cluster_labels = torch.tensor(train_cluster_labels, device=train_x.device)
        
        valid_cluster_labels = kmeans.predict(valid_x_prepped.cpu().numpy())
        valid_cluster_labels = torch.tensor(valid_cluster_labels, device=valid_x.device)
