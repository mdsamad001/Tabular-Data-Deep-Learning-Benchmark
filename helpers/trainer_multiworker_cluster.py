...
def model_pretraining(model, train_x, valid_x,
    ...
    settings['corruptor1']['cluster_labels'] = cluster_labels
    settings['corruptor2']['cluster_labels'] = cluster_labels


    train_dataset = data_utils.TensorDataset(train_x.to('cpu'), cluster_labels)
