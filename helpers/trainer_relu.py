...
# overwrite pretrain model
class UnsupervisedScarf(nn.Module):
    def __init__(self, input_size, hidden_size = 256, embedding_size = 256):
        '''
...
def ae_training(dataset_name, batch_size,
    ...
    for fold_counter in range(fold_limit):
        ...
        torch.save(pretrain_model, f'{save_path}_pretrained-model_{fold_counter}.pkl')
