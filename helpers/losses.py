...
def _get_cluster_loss(z, i, j, y, temperature=1):
    exp_z = torch.exp(z)
    ...
    loss = _loss_term(exp_z, i, j, temperature) + _loss_term(exp_z, i, i_prime, temperature) \
        + _loss_term(exp_z, i, j_prime, temperature) + _loss_term(exp_z, i_prime, j_prime, temperature)
    return loss / 4
